...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from 'hadeswap-beta-sdk'
...
export default function Swap() {
    ...
    }, [attemptingTxn, showConfirm, swapErrorMessage, undefined, txHash])
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Bridge`)} | Soul</title>
                <meta
                    name="description"
