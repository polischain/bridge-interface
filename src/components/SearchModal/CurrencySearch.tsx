        ...
        <ContentWrapper>
            ...
            <div className="mt-3 mb-8">
                <input
                    ...
                    className="w-full bg-transparent border-gradient-r-blue-darker-dark-900 border-transparent border-solid border-1 rounded placeholder-secondary focus:placeholder-primary  font-bold text-caption px-6 py-3.5"
                />
            </div>
            {showCommonBases && (
                <div className="mb-4">
